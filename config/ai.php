    ...
    */
    ...
    'providers' => [
        'openrouter' => [
            ...
            'timeout' => env('OPENROUTER_TIMEOUT', 180),
        ],

        // Same OpenRouter account exposed as a second failover slot so
        // laravel/ai can hop between free models on rate limits/outage.
        'openrouter_backup' => [
            'driver' => 'openrouter',
            'key' => env('OPENROUTER_API_KEY'),
            'timeout' => env('OPENROUTER_TIMEOUT', 180),
