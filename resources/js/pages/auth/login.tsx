...
import { create as passwordRequest } from '@/actions/App/Http/Controllers/Auth/PasswordResetLinkController';
                ...
                <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center">
                            ...
                            {canResetPassword && (
                                <TextLink href={passwordRequest().url} className="ml-auto text-sm" tabIndex={5}>
                                    Forgot password?
                                </TextLink>
                            )}
                        </div>
